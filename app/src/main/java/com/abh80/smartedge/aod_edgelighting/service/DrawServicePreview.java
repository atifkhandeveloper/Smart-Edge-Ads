...
public class DrawServicePreview extends Service {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action != null) {
                if (action.equals("android.intent.action.SCREEN_ON")) {
                    DrawServicePreview.this.myPreview.startAnim();
                } else {
                    DrawServicePreview.this.myPreview.stopAnim();
                }
            }
        }
    };
    ...
    public final void makeNotification() {
        ...
        if (notificationManager2 != null) {
            ...
            Intent intent2 = new Intent(this, DrawServicePreview.class);
            intent2.setAction(ConstMy.ACTION_STOP);
            PendingIntent service = PendingIntent.getService(this, 111, intent2, 134217728);
            Intent intent3 = new Intent(this, DrawServicePreview.class);
